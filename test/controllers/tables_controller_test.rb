...
class TablesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create table" do
    assert_difference("Table.count") do
      post tables_url, params: { table: { isactive: @table.isactive, seatnumber: @table.seatnumber, tablename: @table.tablename } }
    end
  ...
  test "should update table" do
    patch table_url(@table), params: { table: { isactive: @table.isactive, seatnumber: @table.seatnumber, tablename: @table.tablename } }
